...
const UI_TEXT = {
  ...
  ms: {
    ...
    trial1Short: "Kali 1 (Tak Gesek)",
    trial2: "Ujian 2: gosok dengan kain kering selama 2 minit",
    trial2Short: "Kali 2 (2 Menek)",
    trial3: "Ujian 3: gosok dengan kain kering selama 5 minit",
    trial3Short: "Kali 3 (5 Menek)",
    next: "Seterusnya >>",
    listen: "Baca skrin",
    resultTitle: "Hasil Kajiye",
    objectColumn: "Objek",
    outcomeColumn: "Hasil",
    timeColumn: "Masa (minit)",
    visualColumn: "Paparan tarikan cebisan kertas",
    objectValue: "Belon + Cebisan Kertas",
    outcomeNone: "Tak Berubah ",
    outcomeMid: "Siket kertah keno tarek sikit",
    outcomeHigh: "Siket kertah keno tarek banyok sekali",
    closeResult: "Tutup",
    continueExperiment: "Teruskan",
    summaryReady: "Tengok Hasil Kajiye ",
    summaryProgress: "Haghak buwak kajiye wi cukup 3 kali sebelum buwak hasil kajiye.",
