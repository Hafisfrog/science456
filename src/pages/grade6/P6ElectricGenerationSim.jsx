...
const UI_TEXT = {
  ...
  ms: {
    ...
    trial1Short: "กาลี 1 (เตาะแกแซะ)",
    trial2: "Ujian 2: gosok dengan kain kering selama 2 minit",
    trial2Short: "กาลี 2 (2 แมแนะ)",
    trial3: "Ujian 3: gosok dengan kain kering selama 5 minit",
    trial3Short: "กาลี 3 (5 แมแนะ)",
    next: "Seterusnya >>",
    listen: "Baca skrin",
    resultTitle: "ฮาเซ ปือจูบอแอ",
    objectColumn: "Objek",
    outcomeColumn: "Hasil",
    timeColumn: "Masa (minit)",
    visualColumn: "Paparan tarikan cebisan kertas",
    objectValue: "Belon + Cebisan Kertas",
    outcomeNone: "เตาะ บือรูเบาะฮ",
    outcomeMid: "กือรือตะฮ กือนอ ซือเราะ ซีกิ",
    outcomeHigh: "กือรือตะฮ กือนอ ซือเราะ บาเญาะ ซือกาลี",
    closeResult: "Tutup",
    continueExperiment: "Teruskan",
    summaryReady: "แตเงาะฮาเซปือจูบอแอ",
    summaryProgress: "มีเตาะ บูวะ ปือจูบอแอ วี จูโกะ 3 กาลี ซือบือลง บูวะ ฮาเซ ปือจูบอแอ",
    summaryDone: "บูวะ ปือจูบอแอ ซูเดาะฮ จูโกะะ 3 กาลี, แตเงาะ ฮาเซ ซือลาลู",
