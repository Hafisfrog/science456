...
function StepPill({ no, text, onSpeak }) {
  return (
    <div className="group flex min-h-[68px] w-full items-center gap-3 rounded-full border-[3px] border-[#4b628e] bg-gradient-to-b from-[#eef4fb] to-[#d7e0ea] px-4 py-2 shadow-[0_6px_0_#91a0b8,0_16px_22px_rgba(30,41,59,0.14)]">
      ...
      <span className="flex-1 text-[clamp(22px,2vw,28px)] font-bold leading-tight text-[#213760]">
        {text}
      </span>
      <button
        type="button"
        onClick={onSpeak}
        className="ml-auto inline-grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-[#d7e9ff] text-[#1b60c9] shadow-[0_6px_14px_rgba(23,76,160,0.22)] transition hover:-translate-y-0.5 hover:shadow-[0_10px_18px_rgba(23,76,160,0.3)]"
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        />
        <span className="absolute right-[19vw] top-[18vh] text-[clamp(18px,1.6vw,28px)] text-[#f7bd2b]">
          ✦
        </span>
        <span className="absolute right-[15.6vw] top-[21vh] text-[clamp(16px,1.3vw,22px)] text-[#f7bd2b]">
          ✦
        </span>
      ...
      <div className="relative mx-auto flex h-full w-full max-w-[1800px] flex-col px-[clamp(24px,4vw,72px)] pb-[120px] pt-[22px]">
        ...
        <section className="ml-[clamp(6px,8vw,150px)] mt-[clamp(22px,3.5vh,44px)] w-[min(58vw,780px)] max-w-[780px]">
          ...
          <div className="mt-[clamp(18px,3vh,32px)] space-y-[clamp(16px,2.4vh,26px)]">
            <StepPill
              no={1}
              text={content.steps[0]}
              onSpeak={() => speakText(content.steps[0], voice)}
            />
            <StepPill
              no={2}
              text={content.steps[1]}
              onSpeak={() => speakText(content.steps[1], voice)}
            />
            ...
            <StepPill
              no={3}
              text={content.steps[2]}
              onSpeak={() => speakText(content.steps[2], voice)}
            />
          </div>
        </section>
      </div>
