...
const TEXT = {
  ...
  ms: {
    ...
    previewLabel: "Gama penerange (tukar tok buleh)",
    trialLabel: "Kawase Kajiye (Buleh Teke)",
    steps: "Cara guno 1) Tengok gama penerange 2) Cabuk bo pelito dale kawase kajiye 3) Tengok hasil sekaghe",
    series: {
      heading: "Hubung Secaro Berseri",
      on: "Litar buko -> Keduwo bo pelito cerah",
      off: "Tanggal satu mentol -> litar terbuka, kedua-dua mentol padam",
    },
    parallel: {
      heading: "Hubung Secaro Berselari",
      on: "Litar katuk -> Keduwo bo pelito cerah",
