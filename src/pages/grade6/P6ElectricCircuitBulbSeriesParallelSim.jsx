...
const TEXT = {
  ...
  ms: {
    ...
    previewLabel: "กามา รูยุแก(ตูกา เตาะ บูเละฮ)",
    trialLabel: "กาวาแซ ปือจูบอแอ (บูเละฮ ตือแก)",
    steps: "จารอ กูนอ; 1)แตเงาะ กามา รูยุแก 2)จาบุ โบ ปือลีตอ ดาแล กาวาแซ ปือจูบอแอ 3)แตเงาะ ฮาเซ ซือกาแร",
    series: {
      heading: "ฮูบง ซือจารอ แดแระ",
      on: "ลีตาร บูกอ -> กือดูวอ โบ ปือลีตอ จือเราะฮ",
      // off: "Tanggal satu mentol -> litar terbuka, kedua-dua mentol padam",
    },
    parallel: {
      heading: "ฮูบง ซือจารอ ซือลารี",
      on: "ปูตาแร กาโตะ -> กือดูวอ โบ ปือลีตอ จือเราะฮ",
