...
const TEXT = {
  ...
  ms: {
    chooseTitle: "Pilih 4 tokol",
    chooseHint: "Mulo dari bateri 4 tokol, herek bubuh dale bakul 1-4 tokol, lepahtu buko suwih tengok cerah taro mano",
    ...
    selectedLabel: (n) => `Pilih ${n} Tokol`,
    expectedPrefix: "Hasil hok keno napok:",
    optionLabels: ["1 Tokol", "2 Tokol", "3 Tokol", "4 Tokol"],
    optionNotes: [
      "Bo pelito cerah sikit",
      "Bo pelito kho cerah",
      "Bo pelito kho cerah lagi",
      "Bo pelito napok cerah lebih \nbanyok",
    ],
    switchStatus: {
      off: "Suis dimatikan",
      low: "Malap",
    ...
    looseCellsLabel: "Pisah bateri sebelum bubuh dale bakul :",
