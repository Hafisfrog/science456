...
const TEXT = {
  ...
  ms: {
    chooseTitle: "ปีเละฮ 4 ตอกอ",
    chooseHint: "มูลอ ดารีแบะตือรี4 ตอกอ, แฮแระ บูโบะฮ ดาแล บือกะฮ กอเตาะ 1-4 ตอกอ, ลือปะฮ ตูบูกอ ซูวิฮแตเงาะ จือเราะฮ ซือตารอ มานอ",
    ...
    selectedLabel: (n) => `ปีเละฮ ${n} ตอกอ`,
    expectedPrefix: "ฮาเซ เฮาะ กือนอ นาเปาะ",
    optionLabels: ["1 Tokol", "2 Tokol", "3 Tokol", "4 Tokol"],
    optionNotes: [
      "โบ ปือลีตอ จือเราะฮ ซีกิ",
      "โบ ปือลีตอ คอฮอ จือเราะฮ",
      "โบ ปือลีตอ จือเราะฮ บาเญาะ",
      "โบ ปือลีตอ นาเปาะ จือเราะฮ บาเยาะ ซือกาลี",
    ],
    switchStatus: {
      off: "Suis dimatikan",
      low: "Malap",
    ...
    looseCellsLabel: "ปีซะฮ์ แบะตือรีซือบือลง บูโบะฮ ดาแล บือกะฮ กอเตาะ",
    ...
    bulbOff: "โบ ปือลีตอ เตาะจือเราะฮ",
    back: "ฮูโนกือเละ",
    next: "ตือรุฮ",
    ...
    >
      ...
      <div className="fixed bottom-3 left-3 z-20 md:bottom-7 md:left-7">
        ...
        <div className="fixed bottom-3 right-3 z-20 flex items-center gap-3 md:bottom-7 md:right-7">
          ...
          <button
            className={`rounded-[18px] px-[18px] py-[14px] text-[20px] font-black text-white shadow-[0_22px_46px_rgba(0,0,0,.22)] transition max-[720px]:rounded-[16px] max-[720px]:px-[16px] max-[720px]:py-[12px] max-[720px]:text-[18px] ${
              isCircuitReady
                ? "bg-[#2563eb] hover:-translate-y-0.5 hover:shadow-[0_28px_56px_rgba(0,0,0,.26)] active:translate-y-[1px] active:shadow-[0_10px_22px_rgba(0,0,0,.18)]"
