...
export default function P6ElectricObjectives() {
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute right-[10%] top-[15%] h-11 w-11 bg-[#ffc84b]"
        style={{ clipPath: "polygon(50% 0,62% 38%,100% 50%,62% 62%,50% 100%,38% 62%,0 50%,38% 38%)" }}
      />
      <div
        className="pointer-events-none absolute right-[22%] top-[16%] h-12 w-12 bg-[#ffc84b]"
        style={{ clipPath: "polygon(50% 0,62% 38%,100% 50%,62% 62%,50% 100%,38% 62%,0 50%,38% 38%)" }}
      />
      <div className="pointer-events-none absolute left-[6%] bottom-[22%] text-[92px] leading-none opacity-75 max-[900px]:hidden">
        🧲
      </div>
