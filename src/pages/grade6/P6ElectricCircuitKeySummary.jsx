...
const TEXT = {
  ...
  ms: {
    sectionParts: "บาฮาเกียแอ ปูตาแร อาปี",
    parts: [
      { heading: "ตือปะ ฮาเซ อาปี", body: "บูวี ตือนากอ อาปี ซือปือตีแบะตือรี ปือลีตอ แปแจะ,แบะตือรี" },
      { heading: "วอยา อาปี", body: "ฮูบง ดืองา ลีตาร วีอารุฮ อาปี จาแลซือปือตี โบ ปือลีตอ, มอเตอ" },
      { heading: "อาละ อาปี", body: "ตูกา ตือนากอ อาปี ยาดี ตือนากอลา-เอ็ง ซือปือตี โบ ปือลีตอ,มอเตอ" },
    ],
    compareTitle: "บาเน็ง จารอ ฮูบง ปูตาแร อาปี",
    table: {
      head: ["ตาโยะ", "แดแระ", "ซือลารี"],
      rows: [
        ["จารอ ฮูบง", "ฮูบง แดแระ ซาตู อาเราะฮ", "ฮูบง ปีเซาะฮ-ปีเซาะฮ วี ยาดีบาเญาะ อาเราะฮ"],
        ["กือจือรอแฮ โบ ปือลีตอ", "คอฮอ ตาเมาะฮ โบ ปือลีตอคอฮอ จือเราะฮ", "ซือตียะ โบ ปือลีตอ ญาลอ แดจือเราะฮ ซามอ-ซามอ"],
        ["กาลู ปูเนาะฮ โบ ปือลีตอ ซาตู บูเต", "มาตี ซือมอ ปูตาแร อาปี", "โบ ปือลีตอ เฮาะ ลา-เอ็งบูเละฮ ญาลอ ลากี"],
        ["จอตอ จารอ กูนอ", "ปือลีตอ แปเจะ", "อาปีดาแล อูเมาะฮ"],
      ],
    },
    back: "ฮูโนกือเละ",
    next: "สูเดาะบือลาจา",
