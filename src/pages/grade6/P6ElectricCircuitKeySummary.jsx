...
const TEXT = {
  ...
  ms: {
    sectionParts: "Bahagiye Litar Letrik",
    parts: [
      { heading: "Tepat kejadiye letrik ", body: "Beri tenago letrik sepertibateri pelito pecek, bateri                        " },
      { heading: "Woyar letrik", body: "Hubung dengan litar wi arus letrik jale seperti bo pelita, moto" },
      { heading: "Alat letrik", body: "Tuka tenago letrik jadi tenago lain seperti bo pelito, motor" },
    ],
    compareTitle: "Baneng caro hubung litar letrik",
    table: {
      head: ["Tajuk", "Berseri", "Selari"],
      rows: [
        ["Caro hubung", "Hubung derek satu arah", "Banyak laluan"],
        ["Cerah hok bo pelito", "Kho tamoh bo pelito kho cerah", "Setiyak bo pelito nyala dan cerah samo-samo"],
        ["Jiko rusok bo pelito satu bute", "Mati semuwo litar", "Bo pelito yang lain buleh nyalo lagi"],
        ["Contoh caro guno", "Pelito pecek", "Letrik dale rumah"],
      ],
    },
    back: "Pusing semula",
    next: "Teruh",
