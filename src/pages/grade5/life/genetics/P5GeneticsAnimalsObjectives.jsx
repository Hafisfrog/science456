...
const CONTENT = {
  th: {
    ...
    objectives: [
      "ศึกษาการถ่ายทอดลักษณะทางพันธุกรรมของสัตว์จากพ่อแม่สู่ลูก",
  ...
  en: {
    ...
    objectives: [
      "Study how genetic traits are passed from animal parents to offspring.",
  ...
  ms: {
    exp: "Kajiye 1",
    title: "Tajuk Sifat Bako Hok Binatang",
    section: "Tujuwe Pembelajare",
    objectives: [
      "ปือลายา จารอ ปีเนาะฮ ซีฟะ บากอ ยือนิฮ บีนาแต ดารี อีบู บาเปาะ โกะ อาเนาะ",
      "ฮูราย ซีฟะ เลอเบะฮ กูวะ ดืองา ซีฟะ กูแร กูวะ เฮาะ ยีน",
    ],
    back: "ฮูโน กือเละ",
    next: "ตือรุฮ",
    speak: "Dengar",
...
const MALAY_OBJECTIVE_AUDIO = ["/audio/p5/16.1.mp3", "/audio/p5/16.2.mp3"];

export default function P5GeneticsAnimalsObjectives() {
      ...
      <div className="relative z-10 min-h-[100dvh] px-[clamp(14px,3vw,32px)] pb-[clamp(124px,15vh,172px)] pt-5">
        <header className="pt-[clamp(34px,7vh,82px)] text-center">
          <div className="flex flex-wrap items-center justify-center gap-3">
            <h2 className="m-0 text-[clamp(36px,5.1vw,78px)] font-black leading-none text-[#b02b31] [-webkit-text-stroke:clamp(4px,0.65vw,9px)_#efb2d0] drop-shadow-[0_5px_0_rgba(255,255,255,.7)] [paint-order:stroke_fill]">
              {content.exp}
            </h2>
            {/* <button
        ...
        <div className="fixed bottom-[18px] right-[18px] z-40 max-[720px]:bottom-[12px] max-[720px]:left-[12px] max-[720px]:right-[12px]">
          <FoodChainNavButtons
            ...
            onNext={() => navigate("/p5/life/genetics/animals/skills")}
            nextArrow={"\u00BB"}
          />
        </div>
      </div>
