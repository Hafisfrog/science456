...
const CONTENT = {
  th: {
    exp: "การทดลองที่ 3",
    title: "เรื่อง ลักษณะทางพันธุกรรมของคน",
    section: "จุดประสงค์การเรียนรู้",
    objectives: [
      "ศึกษาความแตกต่างระหว่างลักษณะทางพันธุกรรมกับลักษณะที่เกิดจากการเรียนรู้",
      "ฝึกการพิจารณาข้อมูลและตัดสินใจอย่างมีเหตุผลจากตัวอย่างจริง",
    ],
    back: "ย้อนกลับ",
    next: "ต่อไป",
    speak: "ฟัง",
  ...
  en: {
    exp: "Experiment 3",
    title: "Genetic Traits of Humans",
    section: "Learning Objectives",
    objectives: [
      "Study the difference between inherited traits and traits learned through experience.",
      "Practice examining information and making reasoned decisions from real examples.",
    ],
    back: "Back",
    next: "Next",
    speak: "Listen",
  ...
  ms: {
    exp: "Eksperimen 3",
    title: "Ciri Genetik Manusia",
    section: "Objektif Pembelajaran",
    objectives: [
      "Mengkaji perbezaan antara ciri genetik dengan ciri yang diperoleh melalui pembelajaran.",
      "Melatih pertimbangan maklumat dan membuat keputusan beralasan daripada contoh sebenar.",
    ],
    back: "Kembali",
    next: "Seterusnya",
    speak: "Dengar",
      ...
      <div className="relative z-10 min-h-[100dvh] px-[clamp(14px,3vw,32px)] pb-[clamp(124px,15vh,172px)] pt-5">
        <header className="pt-[clamp(34px,7vh,82px)] text-center">
          <div className="flex flex-wrap items-center justify-center gap-3">
            <h2 className="m-0 text-[clamp(36px,5.1vw,78px)] font-black leading-none text-[#5b93e9] [-webkit-text-stroke:clamp(4px,0.65vw,9px)_#c6e0f7] drop-shadow-[0_5px_0_rgba(255,255,255,.7)] [paint-order:stroke_fill]">
              {content.exp}
            </h2>
            {/* <button
        ...
        <main className="mx-auto mt-[clamp(22px,4vh,50px)] w-full max-w-[min(1380px,94vw)]">
        ...
        <div className="fixed bottom-[18px] right-[18px] z-40 max-[720px]:bottom-[12px] max-[720px]:left-[12px] max-[720px]:right-[12px]">
          <FoodChainNavButtons
            ...
            onNext={() => navigate("/p5/life/genetics/humans/skills")}
            nextArrow={"\u00BB"}
          />
        </div>
      </div>
