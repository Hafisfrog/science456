...
const CONTENT = {
  ...
  ms: {
    ...
    objectives: [
      "บูเละฮ ฮูราย ซีฟะ บากอ เฮาะ ปีเนาะฮ ดารี อีบู บาเปาะ โกะ อาเนาะ ",
      "บูเละฮ บาเนง ซีฟะ บากอ เฮาะ บือนอ ฮีโดะ ",
    ],
    back: "ฮูโน กือเละ",
    next: "ตือรุฮ",
    speak: "Dengar",
...
const MALAY_OBJECTIVE_AUDIO = ["/audio/p5/13.1.mp3", "/audio/p5/13.2.mp3"];
