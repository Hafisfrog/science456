...
const CONTENT = {
  ...
  ms: {
    ...
    objectives: [
      "ปือลายา จารอ ปีเนาะฮ ซีฟะ บากอ ยือนิฮ ตูมูแฮ ดารี อีบู บาเปาะ โกะ อาเนาะ ",
      "ฮูราย ซีฟะ ลือเบะฮ กูวะ ดืองา ซีฟะ กูแร กูวะ เฮาะ ยีน ",
    ],
    back: "ฮูโน กือเละ",
    next: "ตือรุฮ",
    speak: "Dengar",
...
const MALAY_OBJECTIVE_AUDIO = ["/audio/p5/19.1.mp3", "/audio/p5/19.2.mp3"];
