...
const CONTENT = {
  ...
  ms: {
    ...
    skills: [
      ...
      "กือมาฮีแร ตัฟเซ มะนอ มะลูมะ ดืองา บูวะ เกอซีปูแล ",
...
export default function P5GeneticsHumansScienceSkills() {
    ...
    <div className="relative h-[100svh] w-full overflow-hidden bg-[url('/images/p5/back.png')] bg-cover bg-center bg-no-repeat font-['Prompt',sans-serif]">
      ...
      <div className="relative z-10 flex h-full flex-col justify-center px-[clamp(14px,3vw,32px)] pb-[104px] pt-4 sm:pb-[96px] md:pb-[86px] md:pt-5">
        <header className="text-center">
          <h2 className="m-0 text-[clamp(34px,4.7vw,72px)] font-black leading-none text-[#5b93e9] [-webkit-text-stroke:clamp(4px,0.55vw,8px)_#c6e0f7] drop-shadow-[0_5px_0_rgba(255,255,255,.7)] [paint-order:stroke_fill]">
            {content.exp}
          </h2>
        ...
        <div className="fixed bottom-[18px] right-[18px] z-40 max-[720px]:bottom-[12px] max-[720px]:left-[12px] max-[720px]:right-[12px]">
          <FoodChainNavButtons
            ...
            onBack={() => navigate("/p5/life/genetics/humans/objectives")}
            onNext={() => navigate("/p5/life/genetics/humans")}
            nextArrow={"\u00BB"}
          />
        </div>
      </div>
