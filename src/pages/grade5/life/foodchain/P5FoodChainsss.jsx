...
const CONTENT = {
  ...
  ms: {
    ...
    consumerCards: [
      {
        id: "herbivore",
        title: "Nate Make Tumbuhe",
        examples: "Ulat, Belale, Lembu, Arnab",
        toneClass: "border-[#f7b54a]",
      },
      {
        id: "omnivore",
        title: "Nate Make Tumbuhe dan Nate",
        examples: "Aye, Itek, Babi, Beruwe, Beruk, Manusia",
        toneClass: "border-[#ff8352]",
      },
      {
        id: "carnivore",
        title: "Nate Make Daging",
        examples: "Gingo, Ula, Rimau, boyo, Helang",
        toneClass: "border-[#ff5c50]",
      },
    ],
