...
const LANGUAGE_SWITCHER_STYLES = {
  default: {
    ...
    button:
      "min-w-[4rem] rounded-full px-2.5 py-2 text-xs font-black transition sm:min-w-[5rem] sm:px-3.5 sm:py-2.5 sm:text-[1.15rem]",
  ...
  materials: {
    ...
    button: "rounded-[14px] px-[18px] py-[10px] text-base font-black transition",
    active: "bg-[#bcd2f1] text-[#31435c]",
    inactive:
...
const NAV_BUTTON_STYLES = {
  default: {
    ...
    back:
      "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-full bg-white px-4 py-2 text-xs font-black text-[#30445c] shadow-[0_8px_20px_rgba(15,23,42,0.12)] transition hover:-translate-y-0.5 hover:bg-[#fbfcf8] sm:px-6 sm:py-2.5 sm:text-[1.15rem]",
    next:
      "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-full bg-[#08c95a] px-4 py-2 text-xs font-black text-white shadow-[0_10px_24px_rgba(8,201,90,0.24)] transition hover:-translate-y-0.5 hover:bg-[#07b351] sm:px-6 sm:py-2.5 sm:text-[1.15rem]",
  },
  materials: {
    wrapper: "flex items-center gap-3 max-[720px]:gap-2",
    back:
      "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-[18px] bg-white px-[18px] py-[14px] text-[20px] font-black text-[#30445c] shadow-[0_22px_46px_rgba(0,0,0,.22)] transition hover:-translate-y-0.5 hover:shadow-[0_28px_56px_rgba(0,0,0,.26)] active:translate-y-[1px] max-[720px]:rounded-[16px] max-[720px]:px-[16px] max-[720px]:py-[12px] max-[720px]:text-[18px]",
    next:
      "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-[18px] bg-[#08c95a] px-[18px] py-[14px] text-[20px] font-black text-white shadow-[0_22px_46px_rgba(8,201,90,.24)] transition hover:-translate-y-0.5 hover:bg-[#07b351] hover:shadow-[0_28px_56px_rgba(8,201,90,.30)] active:translate-y-[1px] max-[720px]:rounded-[16px] max-[720px]:px-[16px] max-[720px]:py-[12px] max-[720px]:text-[18px]",
  },
};
