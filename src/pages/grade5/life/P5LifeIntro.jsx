  ...
  return (
    ...
    overflow-hidden">
      ...
      <div className="text-center mb-8 relative z-20">
        ...
        gap-3
        animate-fadeIn">
          <span className="w-8 h-0.5 bg-green-400/50" />
      ...
      h-[calc(100vh-180px)]">
        ...
        <div
          ...
          <div className="relative h-[220px] overflow-hidden">
            ...
            {hoveredCard === 'life' && (
              <div className="absolute inset-0">
                ...
                <div className="absolute bottom-4 right-4 text-3xl animate-bounce delay-100">🐞</div>
              </div>
            )}
          </div>
          ...
          <div className="p-5">
            ...
            <p className="text-sm text-gray-600 mb-3">
              เรียนรู้ความสัมพันธ์ของสิ่งมีชีวิตในระบบนิเวศ
            </p>
        ...
        {/* ===== ลูกศรเชื่อม ===== */}
        <div className="text-4xl text-green-400/50 animate-pulse">
          🌿
        </div>
