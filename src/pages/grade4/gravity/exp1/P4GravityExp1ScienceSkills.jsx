...
export default function P4GravityExp1ScienceSkills() {
  ...
  const BACK_PATH = "/p4/gravity/exp1/objectives";
  const NEXT_PATH = "/p4/gravity/vocab";
    ...
    return {
      ...
      ms: {
        ...
        skills: [
          ...
          "Kemahiran menentukan dan mengawal pemboleh ubah",
        ],
        back: "Kembali",
        next: "Seterusnya",
        speak: "Dengar",
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden font-['Prompt',sans-serif]">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,.10),rgba(255,255,255,.02))]" />
      ...
      <div className="relative h-full w-full p-6 max-[640px]:p-4">
        ...
        <main className="relative z-[3] mx-auto mt-[24px] w-[min(86vw,1640px)] max-[900px]:mt-[20px] max-[640px]:mt-4">
          <div className="mb-[34px] inline-block bg-[linear-gradient(90deg,#75d7e9,#2f61bf)] p-[10px] pr-[18px] shadow-[0_16px_28px_rgba(8,15,35,.28)] max-[900px]:mb-5">
          ...
          <div className="grid grid-cols-2 gap-x-[46px] gap-y-[82px] px-[90px] max-[1200px]:gap-x-[28px] max-[1200px]:gap-y-[52px] max-[1200px]:px-6 max-[760px]:grid-cols-1 max-[760px]:gap-y-4 max-[760px]:px-0">
            {t.skills.map((skill, index) => (
              <div
                className="flex items-center gap-[14px] rounded-full border-[12px] border-[#70c4d9] bg-white/96 py-[10px] pl-[16px] pr-[18px] shadow-[0_16px_28px_rgba(8,15,35,.16)] max-[900px]:border-[9px] max-[900px]:py-2 max-[640px]:gap-2 max-[640px]:border-[6px] max-[640px]:pl-2 max-[640px]:pr-2"
                key={skill}
              >
                ...
                <div className="flex-1 text-[30px] font-black leading-[1.22] text-black max-[1300px]:text-[25px] max-[900px]:text-[21px] max-[640px]:text-[17px]">
                  {skill}
                </div>
                <button
