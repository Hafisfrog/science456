...
export default function P4GravityExp2ScienceSkills() {
  const navigate = useNavigate();
  const [lang, setLang] = useState("th");
  const audioRef = useRef(null);

  const BACK_PATH = "/p4/gravity/exp2/objectives";
  const NEXT_PATH = "/p4/gravity/exp2/vocab";
    ...
    <div className="relative h-screen w-screen overflow-hidden font-['Prompt',sans-serif]">
      ...
      <div className="relative h-full w-full p-6 max-[640px]:p-4">
        ...
        <main className="relative z-[3] ml-[42px] mt-[30px] max-w-[1330px] max-[1100px]:ml-[20px] max-[1100px]:max-w-none max-[900px]:ml-4 max-[640px]:m-[18px_0_0]">
          ...
          <div className="grid w-[min(1120px,84vw)] grid-cols-2 gap-x-[86px] gap-y-[28px] pl-[72px] max-[1200px]:gap-x-[42px] max-[1200px]:pl-[30px] max-[760px]:w-full max-[760px]:grid-cols-1 max-[760px]:gap-y-3 max-[760px]:pl-0">
            {t.skills.map((skill, index) => (
              <div
                className={`flex items-center gap-[12px] rounded-full border-[9px] border-[#70c4d9] bg-white/96 py-[8px] pl-[16px] pr-[14px] shadow-[0_16px_28px_rgba(8,15,35,.16)] max-[900px]:border-[8px] max-[900px]:py-2 max-[640px]:gap-2 max-[640px]:border-[5px] max-[640px]:pl-2 max-[640px]:pr-2 ${
                  index === 4 ? "col-start-1 max-[760px]:col-start-auto" : ""
                }`}
                key={skill}
              >
                ...
                <div className="flex-1 whitespace-nowrap text-[30px] font-black leading-[1.22] text-black max-[1300px]:text-[25px] max-[900px]:text-[21px] max-[640px]:whitespace-normal max-[640px]:text-[17px]">
                  {skill}
                </div>
                <button
