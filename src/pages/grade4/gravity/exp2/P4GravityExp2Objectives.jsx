...
export default function P4GravityExp2Objectives() {
  ...
  const NEXT_PATH = "/p4/gravity/exp2/skills";

  const content = useMemo(() => {
    return {
      th: {
        heading: "การทดลองที่ 2",
        title: "เรื่อง แรงดึงดูดของโลกกับน้ำหนักของวัตถุ",
        section: "จุดประสงค์การเรียนรู้",
        objectives: [
          "อธิบายการวัดน้ำหนักของวัตถุโดยใช้เครื่องชั่งสปริงได้",
          "สังเกตการวัดน้ำหนักของวัตถุโดยใช้เครื่องชั่งสปริงได้",
          "เปรียบเทียบน้ำหนักของวัตถุแต่ละชนิดได้",
        ],
        back: "ย้อนกลับ",
        next: "ต่อไป",
        speak: "ฟัง",
      ...
      en: {
        ...
        title: "Earth's Pull and Object Weight",
        section: "Learning Objectives",
        objectives: [
          "Explain how to measure the weight of an object using a spring scale.",
          "Observe the measurement of an object's weight using a spring scale.",
          "Compare the weights of different kinds of objects.",
        ],
        back: "Back",
        next: "Next",
        speak: "Listen",
      ...
      ms: {
        heading: "Eksperimen 2",
        title: "Daya Tarikan Bumi dan Berat Objek",
        section: "Objektif Pembelajaran",
        objectives: [
          "Menerangkan cara mengukur berat objek menggunakan penimbang spring.",
          "Memerhati pengukuran berat objek menggunakan penimbang spring.",
          "Membandingkan berat objek yang berlainan jenis.",
        ],
        back: "Kembali",
        next: "Seterusnya",
        speak: "Dengar",
    ...
    <div className="relative h-screen w-screen overflow-hidden font-['Prompt',sans-serif]">
      ...
      <div className="relative h-full w-full p-6 max-[640px]:p-4">
        ...
        <header className="mt-[20px] text-center max-[900px]:mt-[42px]">
          <div className="text-[58px] font-black leading-none text-[#294a7d] [-webkit-text-stroke:7px_#a9d5ff] drop-shadow-[0_10px_20px_rgba(8,15,35,.34)] [paint-order:stroke_fill] max-[900px]:text-[46px] max-[640px]:text-[34px]">
            {t.heading}
          </div>

          <div className="mt-5 flex items-center justify-center gap-3 max-[640px]:mt-3">
            <div className="border-[5px] border-black bg-white px-[42px] py-[14px] shadow-[0_12px_24px_rgba(0,0,0,.18)] max-[900px]:px-[24px] max-[900px]:py-[10px] max-[640px]:border-[3px] max-[640px]:px-[12px]">
              <h1 className="m-0 text-[44px] font-black leading-tight text-black max-[1200px]:text-[36px] max-[900px]:text-[28px] max-[640px]:text-[20px]">
                {t.title}
              </h1>
            </div>
            <button
        ...
        <main className="relative z-[3] ml-[48px] mt-[42px] max-w-[1120px] max-[1100px]:ml-[24px] max-[1100px]:mr-[240px] max-[1100px]:max-w-none max-[900px]:mr-[180px] max-[900px]:ml-4 max-[640px]:m-[22px_0_0]">
          <div className="mb-[26px] inline-block bg-[linear-gradient(90deg,#75d7e9,#2f61bf)] p-[10px] pr-[18px] shadow-[0_16px_28px_rgba(8,15,35,.28)]">
          ...
          <div className="space-y-[22px] max-[900px]:space-y-4">
            {t.objectives.map((objective, index) => (
              <div
                className="flex items-center gap-[12px] rounded-full border-[9px] border-[#70c4d9] bg-white/96 py-[8px] pl-[18px] pr-[12px] shadow-[0_16px_28px_rgba(8,15,35,.18)] max-[1100px]:border-[8px] max-[1100px]:pl-[14px] max-[640px]:gap-2 max-[640px]:rounded-[24px] max-[640px]:border-[5px] max-[640px]:py-2 max-[640px]:pl-2 max-[640px]:pr-2"
                key={objective}
              >
                ...
                <div className="flex-1 text-[31px] font-black leading-[1.24] text-black max-[1300px]:text-[26px] max-[900px]:text-[22px] max-[640px]:text-[17px]">
                  {objective}
                </div>
                <button
