  ...
  const text = useMemo(
    () => ({
      ...
      ms: {
        ...
        q1: "1.	Beno hok samo, jika duk atah bumi dan bule, beghak beno nok samo ko dok?",
        a1:
          "Tok samo walaupun beno dan jisim samo, Tapi dayo tarekke bumi dan bule tok sama. \n Atah bumi: Dayo tarek banyok, buwakwi beno itu lebih beghak. \n Atah bule: Dayo tarek sedikit daripado bumi buwakwi beno itu tok beghak sangat.",
        speak: "Dengar",
